...
REFDIR="/scratch3/NCEPDEV/swpc/noscrub/Joseph.Schoonover/Software/Development2/WAM-IPE/IPELIB/run/MS0.6_1x80/netcdf/"
# Set the path to where your netcdf output can be found that you want to compare against the reference data.
IPEDIR="/scratch3/NCEPDEV/swpc/noscrub/Joseph.Schoonover/Software/Development2/WAM-IPE/IPELIB/run/development_1x80/netcdf/"
# Set the path to where you want the difference file.
OUTDIR="/scratch3/NCEPDEV/swpc/noscrub/Joseph.Schoonover/Software/Development2/WAM-IPE/IPELIB/run/development_1x80/netcdf_diff/"
...
# Use the ncap script to compute absolute max and rms of output from
# the reference and comparison runs
ncap2 -v -O -S ncapOperations.nco ${1} ${1}
ncap2 -v -O -S ncapOperations.nco ${2} ${2}
